...
urlpatterns = [
    ...
    path('get_dealer/<int:dealer_id>', views.get_dealer_details, name='get_dealer_details_no_slash'),

    # ✅ Dealer Reviews (das fehlte)
    path('get_dealer_reviews/<int:dealer_id>/', views.get_dealer_reviews, name='get_dealer_reviews'),
    path('add_review', views.add_review, name='add_review'),

    # Optionaler API-Alias
    path('api/dealer/<int:dealer_id>/', views.get_dealer_details, name='api_get_dealer'),
